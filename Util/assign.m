function [assignments, unassignedRows, unassignedColumns] = assign(costMatrix, costOfNonAssignment)    
...
check_cost(costMatrix, mfilename);
check_unassigned_cost(costOfNonAssignment, costMatrix, mfilename);
...
[rowInds, colInds] = find(hungar(paddedCost));
